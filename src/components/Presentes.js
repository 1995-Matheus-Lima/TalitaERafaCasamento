...
const Presentes = ({setModal,setId,dados}) => {
  return (
    <div id="containerPresentes">
      ...
      <ul>
        <li>Observe as descrições dos itens, como a <span>cor</span> e o <span>tamanho</span>, antes de realizar a compra.</li>
        ...
        <li>Vai comprar em uma loja física ou em uma loja diferente da que indicamos? <ul><li>Lembre-se de marcar que você vai nos dar o presente X ou Y. Assim, <span>esse presente vai sair do site e evita que outra pessoa nos dê o mesmo item</span>.</li></ul></li>
        <li>Caso você queira dividir um presente com outro convidado, não tem problema. Basta nos avisar pelo WhatsApp<span>  (31) 97118-9951</span>, assim conseguimos agradecer as duas ou mais pessoas responsáveis pela compra.</li>
        <li>Caso você queira nos enviar o valor do presente,marque a compra normalmente no site e envie o valor para o<span>  PIX casamentorafaetalita@gmail.com.</span></li>
      </ul>
